...
impl LuaxElement {
    pub fn new<I: Into<LuaxOpeningElement>, E: Into<Vec<LuaxChild>>>(opening_element: I, children: E) -> Self {
        Self {
            opening_element: opening_element.into(),
    ...
    #[inline]
    pub fn get_opening_element(&self) -> &LuaxOpeningElement {
...
impl LuaxOpeningElement {
    pub fn new<I: Into<Variable>, E: Into<Vec<LuaxAttribute>>>(name: I, attributes: E) -> Self {
        Self {
    ...
    #[inline]
    pub fn set_self_closing(&mut self, token: Token) {
        self.self_closing = Some(token);
    }
    #[inline]
    pub fn get_name(&self) -> &Variable {
        &self.name
    }

    #[inline]
    pub fn get_attributes(&self) -> &Vec<LuaxAttribute> {
        &self.attributes
    }
}
#[derive(Clone, Debug, PartialEq, Eq)]
...
impl LuaxAttribute {
    pub fn new<I: Into<Variable>, E: Into<Expression>>(name: I, value: E) -> Self {
        Self {
            name: name.into(),
            value: value.into()
        }
